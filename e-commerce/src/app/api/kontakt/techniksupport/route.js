...
export async function POST(req) {
    ...
    // Erstelle den Inhalt der E-Mail mit den zusätzlichen Feldern
    const emailContent = `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; padding: 20px; border: 1px solid #ddd;">
        ...
        <p><strong>Gerät:</strong> ${geraet}</p>
    ...
    const mailOptions = {
        ...
        subject: 'Technisches Problem beim online Shop CaseToon',
        html: emailContent,
